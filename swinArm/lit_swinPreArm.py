...
from swinArm.model.swinPreArm import SwinPreARM
...
class LitSwinPreARM(pl.LightningModule):
    ...
    def training_step(self, batch: Batch, _):
        ...
        # self.train_exprate_recorder([h.seq for h in hyps], batch.indices)
        # self.log(
        #     "train_ExpRate", self.train_exprate_recorder,
        #     prog_bar=True,
        #     on_step=False,
        #     on_epoch=True,
        # )
    ...
    def configure_optimizers(self):
        ...
        optimizer = optim.SGD(
            [
                {'params': self.model.encoder.parameters(), 'lr': 0.8},
